...
export const data = [
    {
      ...
      boardIcon: require('../../assets/board-icons/super-mario-party-jamboree-board-icon-1.jpg'),
    },
    {
      id: '2',
      name: "Circuit Débridé",
      description: "Un circuit rapide et sinueux, idéal pour les courses effrénées.",
      boardView: require('../../assets/board-view/super-mario-party-jamboree-website-board-2.webp'),
      boardIcon: require('../../assets/board-icons/super-mario-party-jamboree-board-icon-2.webp'),
    },
    {
      id: '3',
      name: "Île Goomba",
      description: "Une île pleine de Goombas et d'obstacles, un vrai défi pour les aventuriers.",
      boardView: require('../../assets/board-view/super-mario-party-jamboree-website-board-3.webp'),
      boardIcon: require('../../assets/board-icons/super-mario-party-jamboree-board-icon-3.webp'),
    },
    {
      id: '4',
      ...
      boardIcon: require('../../assets/board-icons/super-mario-party-jamboree-board-icon-7.jpg'),
    },
    {
      id: '5',
      name: "Galeries Multicolores",
      description: "Un lieu magique aux couleurs vives, offrant un parcours fascinant et surprenant.",
      boardView: require('../../assets/board-view/super-mario-party-jamboree-website-board-4.webp'),
      boardIcon: require('../../assets/board-icons/super-mario-party-jamboree-board-icon-4.webp'),
    },
    {
      id: '6',
      name: "Pays Western",
      ...
      boardIcon: require('../../assets/board-icons/super-mario-party-jamboree-board-icon-5.jpg'),
    },
    {
      id: '7',
      name: "Château Arc-en-Ciel de Mario",
      description: "Un château magique rempli de mystères et de couleurs éclatantes.",
      boardView: require('../../assets/board-view/super-mario-party-jamboree-website-board-6.webp'),
      boardIcon: require('../../assets/board-icons/super-mario-party-jamboree-board-icon-6.webp'),
    },
  ];
